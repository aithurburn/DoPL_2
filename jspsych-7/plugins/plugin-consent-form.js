var jsPsychConsentForm = (function(jspsych) {
    'use strict';
    ...
    class ConsentFormPlugin {
        ...
        trial(display_element, trial) {
            ...
            new_html += "<div id = 'jspsych-consent-form-stimulus';>" + trial.stimulus + "</div>"
            ...
            for (var j = 0; j < trial.labels.length; j++) {
                ...
                new_html += '<button id = "consentButton' + [j] + '" class="textButton">' + trial.labels[j] + '</button>';
            }
            new_html += "</div>"
            new_html += '</div></div>'
                // add prompt
            ...
            var after_response = function(info) {
                ...
                display_element.querySelector("#jspsych-consent-form-stimulus").className +=
                    " responded";
            ...
            if (trial.stimulus_duration !== null) {
                this.jsPsych.pluginAPI.setTimeout(function() {
                    display_element.querySelector("#jspsych-consent-form-stimulus").style.visibility = "hidden";
    ...
    ConsentFormPlugin.info = info;

    return ConsentFormPlugin;
